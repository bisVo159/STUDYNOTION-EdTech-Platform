...
function Instructor() {
    ...
    const totalAmout=instructorData.reduce((acc,curr)=> acc+curr.totalAmountGenerated,0)
                    ...
                    <div className='my-4 flex h-[450px] space-x-4'>
                        ...
                        <div className='flex min-w-[250px] flex-col rounded-md bg-richblack-800 p-6'>
                            ...
                            <div className='mt-4 space-y-4'>
                                <div>
                                    <p className='text-lg text-richblack-200'>Top Courses</p>
                                ...
                                <div>
                                    ...
                                    <p className='text-3xl font-semibold text-richblack-50'>Rs. {totalAmout}</p>
                                </div>
                            </div>
                        </div>
                    </div>
